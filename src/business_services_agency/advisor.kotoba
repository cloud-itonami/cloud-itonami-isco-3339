(ns business-services-agency.advisor
  "AgencyAdvisor — proposes a business-services-agency operation
  (match a request, coordinate a transaction, handle client funds,
  broker a contract above a threshold value) for a registered client.
  ...
  provenance or client-fund/threshold-brokerage risk;
  `business-services-agency.governor` is the independent system that
  decides whether the proposal may proceed, per the itonami actor
  pattern.

  A proposal is a map:
    {:op :match|:coordinate|:handle-client-funds|:broker-above-threshold
...
(def ^:private system-prompt
  "You are a business-services-agency advisor. Given an agency
